...
<div class="divform">
<h1 id="hf">NEW REPORT </h1>
<form action="newreport.php" enctype="multipart/form-data" method="POST">
<table>
<tr><td>
<label>Doctor Name</label></td><td><input type="text" value="Dr." name="doctor" /><td></tr>
<tr>
<td><label>Date</label></td><td><input type="date" name="date" placeholder="DD-Month-YYYY"/></td></tr>
<tr><td><label>Reason</label></td><td><input type="text" value="For" name="reason" /><td></tr>
<tr><td><label>Upload Report</label></td><td><input type="file"  accept="image/*" name="myfile" /></td></tr>
<tr><td colspan="2"><button type="submit"  name="submit" >Upload</button></td></tr>
</table>
</form>
</div>
</article>
