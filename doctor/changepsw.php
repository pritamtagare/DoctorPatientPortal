...
$row=mysqli_fetch_array($result) ;
  ...
  <ul type="none">
	...
	<li><a class="anchr" href="logout.php"><img height="20px" width="30px" src="../images/logout.png">Logout</a></li>  </ul>
  </div>
  </nav>
...
$db="healthwallet";
$conn=mysqli_connect($host,$user,$pass,$db)or die("connection failed");
$sql="SELECT * FROM doctor  WHERE id=".$_SESSION['did'];
...
if($row['password']==$_POST['opsw'])
{
 ...
 {	 
    $nwpsw=$_POST['cnpsw'];
	$sql="UPDATE doctor SET password = '$nwpsw' WHERE id=".$_SESSION['did'];
	$resultset=mysqli_query($conn,$sql) or die("not updated");
	if($resultset)
   { ?>
	<script>
